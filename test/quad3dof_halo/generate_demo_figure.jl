...
with_theme(theme3d) do
    # result = animate_paper_demo_traj_history(run_data, map_data; fps=30, playback_speed=5.0, loop=true, show_time_label=false, save_path="demo_figure.mp4")
    result = animate_paper_demo_traj_history(run_data, map_data; fps=30, playback_speed=1.0, loop=true, show_time_label=false)
    # screens = [
